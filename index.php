...
<head>
    ...
    <link rel="stylesheet" href="css/css/estilospPag.css">
    ...
    <section class="textos-header">
        <div class="contenedor1">
            <div class="texto">
                ...
                <a href="vista/pag/Contacto.php" class="botones"><button type="">PRUEBALO YA</button></a>
                <a href="vista/pag/Contacto.php" class="botones"><button type="">CONTACTANOS</button></a>
    </section>
    <svg id="wave" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 180" version="1.1"
    ...
    <section class="Portafolio">
            ...
            <div class="galeria-port">
                <div class="imagen-port">
                    ...
                    <div class="hover-galeria">
                        ...
                        <a href="vista/pag/funciones.php"><p>Ver más...</p></a>
                    </div>
                </div>
                <div class="imagen-port">
                ...
                <div class="imagen-port">
                    <img src="img/pag/facturacion.png" alt="">
                    <div class="hover-galeria">
                        <img src="img/pngwing.com.png" alt="">
                        <p>Facturación</p>
                    </div>
        ...
        <div class="contenedor">
            <div class="galeria-port">
                ...
                <div class="imagen-port">
                    <img src="img/pag/inventario.png" alt="">
                    <div class="hover-galeria">
                        <img src="img/pngwing.com.png" alt="">
...
<footer>
        ...
        <h2 class="titulo-final">
            &copy;create by Created BJ&E | FarmAF - 2022
        </h2>
    </footer>
</html>